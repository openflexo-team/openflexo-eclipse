...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>exemple2</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Exemple2Example {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(Exemple2Package.eNS_URI, 
			 Exemple2Package.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.exemple2"));
				City root = Exemple2Factory.eINSTANCE.createCity();
