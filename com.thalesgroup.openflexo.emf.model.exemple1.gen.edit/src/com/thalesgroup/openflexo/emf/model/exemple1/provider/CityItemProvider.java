...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.openflexo.emf.model.exemple1.City} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Exemple1Package.Literals.CITY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Exemple1Package.Literals.CITY__HOUSES);
			childrenFeatures.add(Exemple1Package.Literals.CITY__RESIDENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Exemple1Package.Literals.CITY__HOUSES,
				 Exemple1Factory.eINSTANCE.createHouse()));

		newChildDescriptors.add
			(createChildParameter
				(Exemple1Package.Literals.CITY__RESIDENTS,
				 Exemple1Factory.eINSTANCE.createResident()));
	}
