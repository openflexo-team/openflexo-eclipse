...
public class City1PackageImpl extends EPackageImpl implements City1Package {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link City1Package#eINSTANCE} when that field is accessed. Clients should not invoke it directly.
	...
	public static City1Package init() {
		if (isInited)
			return (City1Package) EPackage.Registry.INSTANCE.getEPackage(City1Package.eNS_URI);

		// Obtain or create and register package
		City1PackageImpl theCity1Package = (City1PackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof City1PackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new City1PackageImpl());
	...
	public void createPackageContents() {
		...
		createEAttribute(cityEClass, CITY__ZIPCODE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCity_Zipcode(), ecorePackage.getEIntegerObject(), "zipcode", null, 0, 1, City.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCity_Houses(), this.getHouse(), null, "houses", null, 0, -1, City.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCity_Residents(), this.getResident(), null, "residents", null, 0, -1, City.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(houseEClass, House.class, "House", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHouse_Owner(), this.getResident(), null, "owner", null, 1, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Type(), this.getHouseType(), "type", null, 1, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHouse_Info(), ecorePackage.getEString(), "info", null, 1, 1, House.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(residentEClass, Resident.class, "Resident", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResident_Name(), ecorePackage.getEString(), "name", null, 1, 1, Resident.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
