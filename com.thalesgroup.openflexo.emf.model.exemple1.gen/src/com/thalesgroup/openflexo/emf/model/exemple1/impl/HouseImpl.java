 ...
 * <ul>
 *   <li>{@link com.thalesgroup.openflexo.emf.model.exemple1.impl.HouseImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link com.thalesgroup.openflexo.emf.model.exemple1.impl.HouseImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.thalesgroup.openflexo.emf.model.exemple1.impl.HouseImpl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HouseImpl extends EObjectImpl implements House {
	...
	protected EClass eStaticClass() {
		return Exemple1Package.Literals.HOUSE;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Exemple1Package.HOUSE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(Resident newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Exemple1Package.HOUSE__OWNER, oldOwner, owner));
	}
	...
	public void setType(HouseType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Exemple1Package.HOUSE__TYPE, oldType, type));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Exemple1Package.HOUSE__INFO, oldInfo, info));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Exemple1Package.HOUSE__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case Exemple1Package.HOUSE__TYPE:
				return getType();
			case Exemple1Package.HOUSE__INFO:
				return getInfo();
		}
