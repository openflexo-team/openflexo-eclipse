...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.openflexo.emf.model.city1.House} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class HouseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	protected void addOwnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_House_owner_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_House_owner_feature", "_UI_House_type"),
				City1Package.Literals.HOUSE__OWNER, true, false, false, null, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_House_type_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_House_type_feature", "_UI_House_type"),
				City1Package.Literals.HOUSE__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Info feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_House_info_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_House_info_feature", "_UI_House_type"),
				City1Package.Literals.HOUSE__INFO, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns House.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		HouseType labelValue = ((House) object).getType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_House_type") : getString("_UI_House_type") + " " + label;
	}
