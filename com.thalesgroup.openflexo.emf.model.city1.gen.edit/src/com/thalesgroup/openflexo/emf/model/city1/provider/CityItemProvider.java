...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.openflexo.emf.model.city1.City} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class CityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				City1Package.Literals.CITY__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Zipcode feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addZipcodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_City_zipcode_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_City_zipcode_feature", "_UI_City_type"),
				City1Package.Literals.CITY__ZIPCODE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_City_type") : getString("_UI_City_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(City1Package.Literals.CITY__HOUSES, City1Factory.eINSTANCE.createHouse()));

		newChildDescriptors.add(createChildParameter(City1Package.Literals.CITY__RESIDENTS, City1Factory.eINSTANCE.createResident()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return City1EditPlugin.INSTANCE;
	}
