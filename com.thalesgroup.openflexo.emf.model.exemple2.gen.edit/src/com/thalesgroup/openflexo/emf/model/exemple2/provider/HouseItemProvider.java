...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.openflexo.emf.model.exemple2.House} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HouseItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Exemple2Package.Literals.HOUSE__OWNER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(House.class)) {
			case Exemple2Package.HOUSE__OWNER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Exemple2Package.Literals.HOUSE__OWNER,
				 ""));
	}
