 ...
 * <ul>
 * <li>{@link com.thalesgroup.openflexo.emf.model.city2.impl.CityImpl#getName <em>Name</em>}</li>
...
public class CityImpl extends EObjectImpl implements City {
	...
	/**
	 * The cached value of the '{@link #getMayor() <em>Mayor</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMayor()
	 * @generated
	 * @ordered
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, City2Package.CITY__NAME, oldName, name));
	}
