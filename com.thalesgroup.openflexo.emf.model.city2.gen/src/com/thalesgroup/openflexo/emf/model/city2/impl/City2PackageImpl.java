...
public class City2PackageImpl extends EPackageImpl implements City2Package {
	 ...
	 * 
	 * <p>This method is used to initialize {@link City2Package#eINSTANCE} when that field is accessed.
	...
	public static City2Package init() {
		if (isInited) return (City2Package)EPackage.Registry.INSTANCE.getEPackage(City2Package.eNS_URI);

		// Obtain or create and register package
		City2PackageImpl theCity2Package = (City2PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof City2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new City2PackageImpl());
