...
public interface City2Factory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Mansion</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Appartment</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Mayor</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
