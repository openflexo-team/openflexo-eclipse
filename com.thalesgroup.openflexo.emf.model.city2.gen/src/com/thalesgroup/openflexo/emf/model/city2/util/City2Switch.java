 ...
 * @generated
 */
public class City2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case City2Package.MANSION: {
			Mansion mansion = (Mansion) theEObject;
			T result = caseMansion(mansion);
			if (result == null)
				result = caseHouse(mansion);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case City2Package.APPARTMENT: {
			Appartment appartment = (Appartment) theEObject;
			T result = caseAppartment(appartment);
			if (result == null)
				result = caseHouse(appartment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>City</em>'. <!-- begin-user-doc --> This implementation returns
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>House</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mansion</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mansion</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMansion(Mansion object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Appartment</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Appartment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mayor</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
