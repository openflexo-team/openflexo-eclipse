...
public class City2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case City2Package.MANSION: {
				...
				if (result == null) result = caseHouse(mansion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case City2Package.APPARTMENT: {
				...
				if (result == null) result = caseHouse(appartment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mansion</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Appartment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
