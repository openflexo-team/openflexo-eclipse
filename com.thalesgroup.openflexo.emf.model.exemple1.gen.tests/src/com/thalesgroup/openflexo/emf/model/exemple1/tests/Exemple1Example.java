...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>exemple1</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Exemple1Example {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(Exemple1Package.eNS_URI, 
			 Exemple1Package.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.exemple1"));
				City root = Exemple1Factory.eINSTANCE.createCity();
