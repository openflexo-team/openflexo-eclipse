...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>city1</b></em>' package. <!-- end-user-doc -->
 * 
 * @generated
 */
public class City1Example {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(City1Package.eNS_URI, City1Package.eINSTANCE);
