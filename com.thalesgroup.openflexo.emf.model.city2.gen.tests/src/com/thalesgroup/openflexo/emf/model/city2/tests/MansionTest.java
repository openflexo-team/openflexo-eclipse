...
/**
 * <!-- begin-user-doc --> A test case for the model object '<em><b>Mansion</b></em>'. <!-- end-user-doc -->
 * 
 * @generated
 */
public class MansionTest extends HouseTest {
	...
	/**
	 * Constructs a new Mansion test case with the given name. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the fixture for this Mansion test case. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	protected void setUp() throws Exception {
		setFixture(City2Factory.eINSTANCE.createMansion());
	}
